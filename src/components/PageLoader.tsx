        ...
        >
          <div className="relative flex flex-col items-center">
            ...
            <motion.div
              ...
              className="mt-8 w-32 h-0.5 bg-neutral-200 dark:bg-neutral-800 rounded-full overflow-hidden"
            >
              <motion.div
                initial={{ x: "-100%" }}
                animate={{ x: "100%" }}
                ...
                className="h-full w-1/2 bg-neutral-900 dark:bg-white rounded-full"
              />
            </motion.div>
            ...
            <div className="absolute inset-0 pointer-events-none">
              {[...Array(12)].map((_, i) => (
                <motion.div
                  ...
                  className="absolute w-1.5 h-1.5 bg-neutral-400 dark:bg-neutral-600 rounded-full"
                  style={{
