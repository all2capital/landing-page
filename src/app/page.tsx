...
function HomeSlide() {
  ...
  return (
    <div className="flex-1 min-h-0 relative flex flex-col overflow-hidden">
      ...
      {/* a16z-style bottom bar */}
      <div className="relative z-10 shrink-0 border-t border-white/10">
        <div className={`${alignmentWrapper} py-3 sm:py-4 flex items-center justify-between`}>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/company/alltogethercapital"
              target="_blank"
              rel="noopener noreferrer"
              className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full border border-white/15 text-white/40 hover:text-white/80 hover:border-white/30 transition-colors"
              aria-label="LinkedIn"
            >
            ...
            {/* X / Twitter */}
            <a
              href="https://x.com/alltogethercap"
              target="_blank"
              rel="noopener noreferrer"
              className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full border border-white/15 text-white/40 hover:text-white/80 hover:border-white/30 transition-colors"
              aria-label="X"
