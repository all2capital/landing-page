  ...
  return (
    <div className="flex-1 min-h-0 relative flex flex-col">
      ...
      <div className="relative z-10 border-t border-white/10">
        <div className={`${alignmentWrapper} py-4 flex items-center justify-between`}>
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="w-8 h-8 flex items-center justify-center rounded-full border border-white/15 text-white/40 hover:text-white/80 hover:border-white/30 transition-colors"
              aria-label="LinkedIn"
            >
